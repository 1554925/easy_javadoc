...
import com.example.cloud.project.integrated.common.utils.Collections;
...
public class Consts {
     ...
     * 基础类型集
     */
    public static final Set<String> BASE_TYPE_SET = Collections.newHashSet("byte", "short", "int", "long", "char", "float",
        "double", "boolean");
    /** 停止词 */
    public static final Set<String> STOP_WORDS = Collections.newHashSet("the", "of");
    /** 默认日期格式 */
    public static final String DEFAULT_DATE_FORMAT = "yyyy/MM/dd";

    /** 可用翻译设置 */
    public static final Set<String> ENABLE_TRANSLATOR_SET = Collections.newHashSet(Consts.YOUDAO_TRANSLATOR,
